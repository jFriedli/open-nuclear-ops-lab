...
export class Engine {
    ...
    action(json) {
        ...
        try {
            ...
            const ret = wasm.engine_action(this.__wbg_ptr, ptr0, len0);
            deferred2_0 = ret[0];
            deferred2_1 = ret[1];
     ...
     */
    get dt() {
        const ret = wasm.engine_dt(this.__wbg_ptr);
        return ret;
    }
    /**
     ...
     */
    set_debug(on) {
        wasm.engine_set_debug(this.__wbg_ptr, on);
    }
    /**
     * @param {boolean} running
     */
    set_running(running) {
        wasm.engine_set_running(this.__wbg_ptr, running);
    }
    /**
     * @param {number} speed
     */
    set_speed(speed) {
        wasm.engine_set_speed(this.__wbg_ptr, speed);
    }
    /**
     * @returns {number}
     */
    get simTime() {
        const ret = wasm.engine_simTime(this.__wbg_ptr);
        return ret;
    }
    /**
    ...
    snapshot() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.engine_snapshot(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
     ...
     */
    step(n) {
        wasm.engine_step(this.__wbg_ptr, n);
    }
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('nol_engine_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
